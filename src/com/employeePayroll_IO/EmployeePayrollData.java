...
public class EmployeePayrollData {
	...
	public EmployeePayrollData(Integer employee_id, String name , Double salary) {
		this.employee_id = employee_id;
		this.name = name;
		this.salary = salary;
	}
	
	public EmployeePayrollData(int employee_id, String name,double salary,LocalDate start) {
	...
	public boolean equals(Object obj) {
		...
		EmployeePayrollData emp = (EmployeePayrollData) obj;
